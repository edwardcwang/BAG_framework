...
class MOSTechPlanarGeneric(MOSTech):
    ...
    def _draw_g_vias(self,
        ...
        if has_od:
            ...
            template.add_via_primitive(via_type, (po_xc, m1_yc + dy), v0_w, v0_h, enc1=enc1, enc2=enc2,
                                       nx=fg, spx=sd_pitch)
    ...
    def _add_via_with_arr_constraint(self, template, mbot_yb, mbot_yt, mtop_yb, mtop_yt, via_type,
        ...
        template.add_via_primitive(via_type, (x0, via_yc), via_w, via_h, num_rows=num_via, sp_rows=via_sp,
